...
fn decompress_mode2(data: &[u8], mut w: OutBuf) -> Result<usize, Error> {
...
#[bitmatch::bitmatch]
fn decompress_mode1(data: &[u8], mut w: OutBuf) -> Result<usize, Error> {
	let f = &mut Reader::new(data);
...
pub fn decompress(data: &[u8], w: &mut Vec<u8>) -> Result<usize> {
